...
In this initial commit, we go from C to an object oriented/event drivent TCP echo server using LibUV, the same asychronous IO library and event loop used in both NodeJS and Rust.
